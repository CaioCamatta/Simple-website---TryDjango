...
STATIC_ROOT = os.path.join(os.path.dirname(BASE_DIR), "static_deployment", "static_root")
...
# -user uploaded-
MEDIA_URL = '/media/'
MEDIA_ROOT = os.path.join(os.path.dirname(BASE_DIR), "static_deployment", "media_root")
